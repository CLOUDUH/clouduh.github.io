...
subtitle: "真没想到 docker 安装起来这么麻烦"
date: "2025-09-17"
author: "CLOUDUH"
header-img: "/cloudu-oss.oss-cn-beijing.aliyuncs.com/blogimg/blog-bg.jpg"
permalink: "/post/25091701"
tags:
  - Homelab
---
...
起因是我发现群晖自带的 Docker 总是频繁唤起硬盘，导致噪音搞得我很难受，正好前段时间添置了一个小主机，就打算应用和数据分离。于是在创建的虚拟机上进行了如下操作，说实话 Docker 的可视化界面还是太宠小白了，导致自己在手搓 docker 的时候完全不知道自己要干什么。
